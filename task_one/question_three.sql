...
SELECT gdp.Country, COALESCE(region.Region, 'null region') as Region, gdp."Year", gdp.gdp, score.Score FROM gdp
JOIN score
	ON gdp.Country = score.Country AND gdp."Year" = score."Year" AND gdp.State_id = score.State_id
LEFT JOIN region
